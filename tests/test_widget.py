...
def test_mask_card_type_platinum():
    """Функция, тестирующая заданное значение банковской карты Visa Platinum с ожидаемым на выходе"""
...
def test_card_type_master():
    """Функция, тестирующая заданное значение банковской карты Master Card с ожидаемым на выходе"""
...
def test_card_type_classic():
    """Функция, тестирующая заданное значение банковской карты Visa Classic с ожидаемым на выходе"""
...
def test_card_type_gold():
    """Функция, тестирующая заданное значение банковской карты Visa Gold с ожидаемым на выходе"""
    new_card_type_gold: str = "Visa Gold 3654775899651233"
    assert mask_card_number(new_card_type_gold) == "Visa Gold 3654 77** **** 1233"


def test_account_number():
    """Функция, тестирующая заданное значение банковского счета с ожидаемой маской на выходе"""
...
def test_masks(card_type, account):
    """Функция, тестирующая заданный номер карты(счета) с ожидаемой маской на выходе"""
    assert mask_card_number(card_type) == "Visa Platinum 4568 45** **** 4868"
    assert mask_card_number(account) == "Счет **2561"


def test_date():
    """Функция, тестирующая входные параметры даты с ожидаемыми после конвертации"""
